function [v1, v2, t, R ] = create2D2DExperiment_baseline( pt_number, cam_number, noise, outlier_fraction, max_baseline )
...
position2 = max_baseline * (rand(3,1) - repmat(0.5,3,1));
